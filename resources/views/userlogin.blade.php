...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
     ...
     <form class="login-form" method="post" action="{{route('userpage') }}" autocomplete="off">
        @csrf
        <div class="box-container" >
            <h2>LOGIN FORM </h2>
            <div class="mb-3">
                Username:<br><input type="text" placeholder="Enter your username"  name= "username" class="name" required=""><br>
            </div>
            <div class="mb-3">
